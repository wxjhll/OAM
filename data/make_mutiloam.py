...
def ground_path_map(image_dir=None):
    #D:/Ldata/NOAM/train/at/L1/5.png
    strlist=image_dir.split('/')
    ground_true='/data/home/Deepin/mutil/noat/'+strlist[-2]+'.png'
    return ground_true

def split_train_val(imgage_dir='/data/home/Deepin/mutil/at',split=0.8):
    ...
    print('验证集：', val_at[10], val_ping[10])
