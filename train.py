...
def train_model(batch_size = 32,epochs = 100,mylr=1e-4,train_dir='',
    ...
    milest =list(range(1, epochs+1, 10))
    ...
    torch.save(model.state_dict(), './weight/modelslm{}.pth'.format(timestamp))
...
if __name__ == '__main__':
    ...
    train_model(batch_size = 32,epochs = 50,train_dir='D:/aDeskfile/slm/at',
                size=[128,128],size_=(128,128),mymodel=model,split=0.95,mylr=1e-3)
